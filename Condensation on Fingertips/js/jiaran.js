...
function loadf() {
    ...
    box2.addEventListener('touchend', function (e) {
        ...
        console.log(document.getElementById('cloth4').style.opacity)
...
function clickRet() {
    ...
    document.getElementById('bg2').style.transform = 'scale(0.7)'
    ...
    document.getElementById('ban').style.top = '727px'//充值布的摆放位置
    flag = 0
}
